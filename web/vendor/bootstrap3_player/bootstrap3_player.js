/* global jQuery */
(function ($) {'use strict';
    $('audio[controls].bootstrap3').before(function () {
        ...
        var addData = function () {
            ...
            // a non-existent data-* variable
            var hasAlbumArt = false;
            if (typeof ($(song).data('infoAlbumArt')) !== 'undefined') {
                hasAlbumArt = true;
                addAlbumArt();
            }
            if (typeof ($(song).data('infoAlbumArtCaption')) !== 'undefined') {
                addInfo('', 'infoAlbumArtCaption');
            }
            ...
            if (hasAlbumArt || $(data_table).html() !== '') {
        ...
        $(document).ready(
            function () {
                $(data_sec).collapse('toggle'); // we expand be default
            }
        )
