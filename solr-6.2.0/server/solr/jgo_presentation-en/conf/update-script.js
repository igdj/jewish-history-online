...
function processAdd(cmd) {
    ...
    if ('person' == entity) {
        ...
        if (description != null && description.length > 1) {
            doc.setField("description_s", description[1]);
        }
        ...
        if (alternateName != null && alternateName.length > 1 && !isEmpty(alternateName[1])) {
            doc.setField("name_s", name_order = alternateName[1]);
        }
